...
<div class="mainCont">
      ...
      <th scope="col">Type of feeds</th>
      <th scope="col">Type of poultry</th>
...
?>
 ...
 <td><?php echo $row['Type of feeds']?></td>
 <td><?php echo $row['Type of poultry']?></td>
...
<!-- About feed -->
<div class="about">
                <h2>About feed records</h2>
                <p>Feeding depends on Age and the type of poultry for instance layers their feeds are layer mash, for broilers their are their feed sme case to chicks etc.For a poultry farm, various types of feed are used to ensure proper nutrition for the birds at different stages of their growth.</p>
            </div>
<footer>
